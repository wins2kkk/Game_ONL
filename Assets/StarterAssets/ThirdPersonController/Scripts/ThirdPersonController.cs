...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Update()
        {
            if (IsCurrentDeviceMouse) // Nếu đang dùng chuột
            {
                Cursor.lockState = CursorLockMode.None; // Chuột không bị khóa
                Cursor.visible = true; // Chuột phải hiển thị
            }
            else
            {
                Cursor.lockState = CursorLockMode.Locked; // Chuột bị khóa vào giữa khi chơi
                Cursor.visible = false; // Ẩn chuột khi không cần
            }
